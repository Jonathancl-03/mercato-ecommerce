<x-app-layout>
    <div class="max-w-2xl mx-auto py-10 px-4">
        ...
        <h1 class="font-display text-3xl font-semibold mb-8 text-ink-900 dark:text-white">Nuevo producto</h1>
        ...
        <form method="POST" action="{{ route('productos.store') }}" class="bg-white dark:bg-ink-900 border border-stone-100 dark:border-white/10 rounded-2xl p-6">
            @csrf
