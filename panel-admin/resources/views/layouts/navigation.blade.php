    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="font-display text-2xl font-semibold text-forest-600">
                        Mercato <span class="text-ink-900/40 text-base font-sans font-normal">Admin</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="config('app.store_url')" :active="false" target="_blank">
                        {{ __('Ir a la tienda') }} ↗
                    </x-nav-link>
                </div>
                <div x-data="{
        ...
        toggle() {
            ...
            localStorage.setItem('theme', this.isDark ? 'dark' : 'light');
                    ...
                    class="flex w-16 h-8 p-1 rounded-full cursor-pointer transition-all duration-300 flex-shrink-0"
