...
<head>
    ...
    <title>Iniciar sesion - Mercato</title>
        ...
        <div class="w-full max-w-4xl overflow-hidden rounded-2xl flex bg-white shadow-xl">
            ...
            <div class="hidden md:block w-1/2 h-[600px] relative overflow-hidden border-r border-stone-100 bg-gradient-to-br from-forest-600/5 to-mustard-500/10">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center p-8 z-10 text-center">
                    ...
                    <h2 class="font-display text-3xl font-semibold mb-2 text-forest-600">Mercato</h2>
                    <p class="text-sm text-ink-900/60 max-w-xs">
                        Inicia sesion para ver tus pedidos, tu carrito y seguir comprando.
                    </p>
                </div>
            </div>

            <div class="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center bg-white" x-data="{ showPassword: false }">
                <h1 class="font-display text-2xl md:text-3xl font-semibold mb-1">Bienvenido de nuevo</h1>
                <p class="text-ink-900/50 mb-8">Inicia sesion en tu cuenta</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    @if (Route::has('register'))
                        <p class="text-center text-sm text-ink-900/60 mt-4">
                            No tienes cuenta?
                            <a href="{{ route('register') }}" class="text-forest-600 hover:underline font-medium">Registrate</a>
                        </p>
                    @endif
                </form>
            </div>
